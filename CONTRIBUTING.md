...
- [Issue tracking system](https://github.com/riverma/terraformly/issues) - a regularly monitored area to report issues with our software or propose changes
...
Make sure people are aware you're working on a patch! Check out our [issue tracking system](https://github.com/riverma/terraformly/issues) and find an open issue you'd like to work against, or alternatively file a new issue and mention you're working on a patch.
...
See our list of issues at: https://github.com/riverma/terraformly/issues
...
- **Check for duplicates** - there may be a bug report already describing your issue, so check the [issue tracking system](https://github.com/riverma/terraformly/issues) first

Here's some guidance on submitting a bug issue:
1. Navigate to our [issue tracking system](https://github.com/riverma/terraformly/issues) and file a new issue
...
- **Check for duplicates** - there may be a new feature issue already describing your issue, so check the [issue tracking system](https://github.com/riverma/terraformly/issues) first
...
Report your security vulnerabilities to: [@riverma](https://github.com/riverma)
...
⚠️ It's **highly** advised that you take a look at our [issue tracking system](https://github.com/riverma/terraformly/issues) before considering any code contributions. Here's some guidelines:
...
⚠️ It's **highly** advised that you take a look at our [issue-tracking system](https://github.com/riverma/terraformly/issues) before considering any documentation contributions. Here's some guidelines:
...
- Answer open questions mentioned in our [issue tracking system](https://github.com/riverma/terraformly/issues)
